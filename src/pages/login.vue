...
.login-title {
  color: #93db34; /* Change title color */
}

.border {
  border: 1px solid #d8db34; /* Change border color */
}

.bg-blue-500 {
  background-color: #93db34; /* Change button background color */
}

.bg-blue-500:hover {
  background-color: #81a51d; /* Change button background color on hover */
}
